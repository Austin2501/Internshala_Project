...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Numerous versions of Lorem Ipsum passages exist, but most have undergone some form of modification, whether through injected humor or the introduction of randomized words. To use Lorem Ipsum text, it's crucial to ensure there's no embarrassing content hidden within the text.</p>
    </div>
    <div class="row"> 
...
<div class="car-title-m car-price">
